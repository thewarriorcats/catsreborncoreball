gameurl = 'http://www.qingchifan.com/game/coreball/game.html';
imgUrl = "http://www.qingchifan.com/images/logo.png";
...
"undefined" == typeof window.$AJB && (window.$AJB = {}),
    ...
    $AJB.general.Game = function() {
        ...
        var h, i, j, k = $AJB.general.Scene(),
            ...
            B = "sinaweibo://share?content=Core Ball，我已玩到第#{level}关了，你也来试试吧！ http://www.qingchifan.com/game/coreball/game.html",
            C = m(s),
            D = +o.getValue(z) || 1,
            E = !1,
            F = 0,
